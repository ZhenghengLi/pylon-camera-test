function(df_standard_exe target_name)
    set(multiValueArgs INCLUDE_DIRS DEFINITIONS LINK_DIRS LINK_OPTIONS LIBRARIES)
    cmake_parse_arguments(ARG "" "" "${multiValueArgs}" ${ARGN})

    file(GLOB sources src/*)
    file(GLOB headers inc/*)
    file(GLOB assets assets/*.qrc)
    add_executable(${target_name} ${sources} ${headers} ${assets})
...
function(df_standard_lib target_name)
    ...
    file(GLOB assets assets/*.qrc)
    add_library(${target_name} SHARED ${sources} ${headers} ${publics} ${assets})
